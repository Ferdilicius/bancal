<div x-data="{
        ...
        <div class="grid gap-4 sm:gap-6 grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @foreach ($paymentMethods as $method)
                <div
                    ...
                    <!-- Nombre y Tipo del método de pago -->
                    <div class="mb-4">
                            ...
                            <div x-data="{ open: false }" class="flex-1 w-full">
                                ...
                                <div x-show="open" x-cloak
                                    ...
                                    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full text-center border border-red-200"
                                        ...
                                        <h2 class="text-xl font-bold mb-4 text-gray-900">¿Borrar método de pago?</h2>
    ...
    @else
        <div class="flex flex-col items-center mt-16 sm:mt-20">
            <i class="fas fa-credit-card text-5xl sm:text-6xl text-gray-300 mb-4 sm:mb-6"></i>
            <p class="text-gray-500 text-center text-lg sm:text-xl font-semibold mb-1 sm:mb-2">Aún no tienes métodos de
                pago guardados</p>
            <p class="text-gray-400 text-center mb-2 sm:mb-4">¡Comienza a agregar métodos de pago para usarlos en tus
                pedidos!</p>
        </div>
    @endif
</div>
