    ...
    <div class="bg-white shadow-xl rounded-3xl p-6 sm:p-10">
        ...
        <div x-data="{ tab: 'productos' }">
            <div class="flex border-b mb-8">
                <button class="px-6 py-3 -mb-px font-semibold text-base focus:outline-none transition border-b-2"
                    :class="tab === 'productos' ? 'border-green-600 text-green-700' :
                        'border-transparent text-gray-500 hover:text-green-600'"
                    @click="tab = 'productos'">
                    Productos
                </button>
                <button class="px-6 py-3 -mb-px font-semibold text-base focus:outline-none transition border-b-2"
                    :class="tab === 'terrenos' ? 'border-green-600 text-green-700' :
                        'border-transparent text-gray-500 hover:text-green-600'"
                    @click="tab = 'terrenos'">
                    Bancales
                </button>
                <button class="px-6 py-3 -mb-px font-semibold text-base focus:outline-none transition border-b-2"
                    :class="tab === 'ventas' ? 'border-green-600 text-green-700' :
                        'border-transparent text-gray-500 hover:text-green-600'"
                    @click="tab = 'ventas'">
                    Ventas
                </button>
                <button class="px-6 py-3 -mb-px font-semibold text-base focus:outline-none transition border-b-2"
                    :class="tab === 'compras' ? 'border-green-600 text-green-700' :
                        'border-transparent text-gray-500 hover:text-green-600'"
                    @click="tab = 'compras'">
                    Compras
                </button>
            ...
            <div x-show="tab === 'productos'">
                                    ...
                                    <div x-data="{ open: false }" class="flex-1">
                                        ...
                                        <div x-show="open" x-cloak
                                            ...
                                            <div class="bg-white rounded-xl shadow-lg p-8 max-w-sm w-full text-center"
                                                ...
                                                <h2 class="text-xl font-bold mb-4">¿Quieres borrar este producto?</h2>
                ...
                @else
                    <div class="flex flex-col items-center mt-20">
                        ...
                        <p class="text-gray-500 text-center text-xl font-semibold mb-2">Aún no tienes productos
                            publicados
                        </p>
            ...
            <div x-show="tab === 'terrenos'">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-10">
                    <a href="#"
                        class="inline-flex items-center bg-green-600 text-white px-7 py-3 rounded-xl hover:bg-green-700 transition-colors duration-200 shadow-lg font-semibold text-base">
                        <i class="fas fa-plus mr-2"></i> Agregar Terreno
                    </a>
                </div>
                {{-- Aquí puedes mostrar la lista de terrenos del usuario --}}
                <div class="flex flex-col items-center mt-20">
                    <i class="fas fa-tree text-6xl text-gray-300 mb-6"></i>
                    <p class="text-gray-500 text-center text-xl font-semibold mb-2">Aún no tienes terrenos publicados
                    </p>
                    <p class="text-gray-400 text-center mb-4">¡Comienza a agregar terrenos para que otros puedan verlos!
                    </p>
                </div>
            </div>
            ...
            <div x-show="tab === 'ventas'">
                <div class="flex flex-col items-center mt-20">
                    ...
                    <p class="text-gray-500 text-center text-xl font-semibold mb-2">Aún no tienes ventas registradas</p>
                    <p class="text-gray-400 text-center mb-4">Tus ventas aparecerán aquí.</p>
                </div>
            </div>
            ...
            <div x-show="tab === 'compras'">
                <div class="flex flex-col items-center mt-20">
                    ...
                    <p class="text-gray-500 text-center text-xl font-semibold mb-2">Aún no tienes compras registradas
                    </p>
                    <p class="text-gray-400 text-center mb-4">Tus compras aparecerán aquí.</p>
                </div>
            </div>
        </div>
    </div>
