<x-guest-layout>
    ...
    <!-- Cuerpo -->
    <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0 bg-[#eaeaea73]">
        <div class="w-full sm:max-w-4xl mt-6 p-6 bg-[#ffffff00] overflow-hidden sm:rounded-lg">
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <div class="pl-6">
                En Bancal, nos tomamos muy en serio la protección de tus datos personales. Esta Política de Privacidad
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <ul class="list-disc list-inside space-y-1">
                    ...
                    <li><strong>Datos de actividad:</strong> productos publicados, compras realizadas, mensajes enviados.</li>
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <div class="pl-6">
                <p class="pl-6">El tratamiento de tus datos se basa en la ejecución de un contrato, tu consentimiento,
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <p class="pl-6">Implementamos medidas técnicas y organizativas adecuadas para proteger tus datos contra
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <p class="pl-6">Tus datos se conservarán mientras tengas una cuenta activa y durante el tiempo necesario
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <a href="mailto:soporte@bancal.es" class="text-blue-600 underline">soporte@bancal.es</a></p>
                </div>
            </section>
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <p class="pl-6">Nos reservamos el derecho a modificar esta política en cualquier momento. Te notificaremos
            ...
            <section class="border border-[#080303] bg-white shadow-sm rounded-lg p-4 mb-6">
                ...
                <p class="pl-6">Esta Política de Privacidad se rige por la normativa vigente en materia de protección de
                datos, incluyendo el Reglamento General de Protección de Datos (UE) 2016/679 (RGPD) y la Ley Orgánica 3/2018
        ...
        <div class="w-full bg-[#fdfdfd] border-t border-gray-200">
            <div class="max-w-4xl mx-auto px-6 py-6 text-center">
                ...
                <p class="mt-1 text-sm text-gray-600">Al utilizar Bancal, confirmas que has leído, entendido y aceptado esta Política de Privacidad.</p>
            </div>
        </div>
    </div>
</x-guest-layout>
