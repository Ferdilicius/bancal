<footer class="bg-[#9E203F] text-white py-8 mt-auto">
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
        <div class="text-center md:text-left">
            ...
            <p class="text-base md:text-lg">Soluciones innovadoras para tu negocio.</p>
        </div>
        <div class="text-center md:text-left">
            ...
            <ul class="text-base md:text-lg space-y-1">
                ...
                <li>
                    ...
                    <a href="mailto:info@bancal.com" class="hover:underline">info@bancal.com</a>
                </li>
                <li>
        ...
        <div class="text-center md:text-left">
            ...
            <div class="flex justify-center md:justify-start gap-3 mt-1 text-xl">
